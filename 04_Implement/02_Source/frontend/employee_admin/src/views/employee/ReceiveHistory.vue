    ...
    <div class="border-container" style="padding:20px;">
        <div class="table-responsive">
            <table class="table table-striped border-table">
                ...
                <tbody v-if="listTransactionToRender && listTransactionToRender.length != 0">
                    <tr v-for="(value,index) in listTransactionToRender" :key="index">
                ...
                <tbody v-else>
                    <tr>
                        <td colspan="6" style="padding:20px;text-align:center;">Not found any customer</td>
                    </tr>
                </tbody>
            </table>
        </div>
