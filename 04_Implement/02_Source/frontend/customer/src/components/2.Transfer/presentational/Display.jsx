...
const Display = ({
  ...
  <div style={{ position: 'relative', width: '100%' }}>
    <Wrapper loading={loading}>
      <StyledRow>
        <Col lg={3}><Text>From:</Text></Col>
        <Col lg={9}><Text>{from}</Text></Col>
      </StyledRow>
      <StyledRow>
        <Col lg={3}><Text>To:</Text></Col>
        <Col lg={9}><Text>{to}</Text></Col>
      </StyledRow>
      <StyledRow>
        <Col lg={3}><Text>Total amount:</Text></Col>
        <Col lg={9}><Text>{amount}</Text></Col>
      </StyledRow>
      <StyledRow>
        <Col lg={3}><Text>Payment fee:</Text></Col>
        <Col lg={9}><Text>{chargedBySender ? 'Charged by the sender (you)' : 'Charged by the receiver'}</Text></Col>
      </StyledRow>
    </Wrapper>
    { loading && <Loading />}
  </div>
