        ...
        { showMenu
          && (
            <Menu>
              ...
              <Item onClick={() => this.handleOnClick(DebtType.LOAN)} type="button">
                <Type type={DebtType.LOAN} />
              </Item>
              <Item onClick={() => this.handleOnClick(DebtType.DEBT)} type="button">
                <Type type={DebtType.DEBT} />
              </Item>
            </Menu>
          )}
      </div>
