...
import { clearStorage, getEmailFromStorage } from '../../../utils/utils'
...
class ResetPasswordForm extends Component {
	...
	async handleSubmit() {
		...
		//   },
		// }
		const res = await api.put('/customers/reset-password', data)
		if (res.error) {
			const { error } = res
			this.setState({
				error,
	...
	render() {
		const { password, confirmPassword, error, loading, done } = this.state
