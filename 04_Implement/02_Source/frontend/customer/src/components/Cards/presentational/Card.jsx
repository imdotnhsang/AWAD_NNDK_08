          ...
          service === 'MASTERCARD'
            ? (
              <Logo width="30" height="19" viewBox="0 0 30 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="9.59355" cy="9.1797" rx="8.85105" ry="9.01197" fill="#F66071" />
                <ellipse cx="20.2148" cy="9.1797" rx="8.85105" ry="9.01197" fill="#FFA522" />
              </Logo>
            )
            : (
              <Logo width="56" height="18" viewBox="0 0 56 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0)">
                  <path d="M24.101 17.7403H19.5955L22.4135 0.315796H26.9187L24.101 17.7403Z" fill="white" />
                  <path d="M40.4335 0.741707C39.5449 0.389148 38.1354 -0.00012207 36.3925 -0.00012207C31.9432 -0.00012207 28.8101 2.37245 28.7909 5.76451C28.7539 8.26717 31.0341 9.6572 32.7395 10.4917C34.4826 11.3444 35.0751 11.9009 35.0751 12.661C35.0574 13.8283 33.6666 14.3664 32.3695 14.3664C30.5707 14.3664 29.6069 14.089 28.1422 13.4395L27.5489 13.1611L26.9185 17.0725C27.9752 17.5539 29.922 17.9812 31.9432 17.9999C36.6707 17.9999 39.7484 15.664 39.7848 12.0492C39.8028 10.0657 38.5988 8.54582 36.003 7.30385C34.4272 6.50659 33.4621 5.969 33.4621 5.15326C33.4806 4.41168 34.2784 3.65211 36.0572 3.65211C37.5219 3.61491 38.598 3.96697 39.4133 4.31929L39.8208 4.50431L40.4335 0.741707Z" fill="white" />
                  <path d="M46.4216 11.5674C46.7926 10.5664 48.2203 6.69217 48.2203 6.69217C48.2016 6.72938 48.5906 5.67268 48.8131 5.02398L49.128 6.52538C49.128 6.52538 49.9811 10.6962 50.1664 11.5674C49.4623 11.5674 47.3115 11.5674 46.4216 11.5674ZM51.9829 0.315796H48.498C47.4233 0.315796 46.6068 0.63066 46.1432 1.76151L39.451 17.74H44.1783C44.1783 17.74 44.9566 15.5894 45.1239 15.1263C45.6425 15.1263 50.2413 15.1263 50.9085 15.1263C51.0378 15.738 51.4461 17.74 51.4461 17.74H55.6176L51.9829 0.315796Z" fill="white" />
                  <path d="M15.8324 0.315796L11.4201 12.1976L10.938 9.78785C10.1222 7.00729 7.56389 3.98626 4.70892 2.48412L8.75042 17.7218H13.5148L20.5965 0.315796H15.8324Z" fill="white" />
                  <path d="M7.32294 0.315796H0.0741579L0 0.667863C5.65451 2.11382 9.39937 5.59926 10.938 9.78859L9.36217 1.78048C9.10274 0.667616 8.30548 0.352505 7.32294 0.315796Z" fill="#FAA61A" />
                </g>
                <defs>
                  <clipPath id="clip0">
