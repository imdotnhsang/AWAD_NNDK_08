...
const RemoveReceiverModal = ({
	...
	const handleDelete = async () => {
		...
		//   },
		// }
		const res = await api.delete('/receivers/delete-receiver', data)
		if (res.error) {
			setLoading(false)
			onClose()
			onFailure(res.error)
	...
	return (
		<Template name='Remove receiver' disabled={loading} onClose={onClose}>
			<Text>
...
export default connect(null, mapDispatchToProps)(RemoveReceiverModal)
