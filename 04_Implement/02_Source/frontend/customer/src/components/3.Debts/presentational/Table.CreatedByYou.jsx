...
class Table extends Component {
	...
	componentDidUpdate() {
		const { loading, scrollTop } = this.props
		if (!loading && scrollTop === true) this.ref.current.scrollArea.scrollTop()
	}
	...
	render() {
		const { data, loading, onInfo, onRemove, onScrollTop } = this.props
