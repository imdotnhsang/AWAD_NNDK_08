        ...
        { showMenu
          && (
            <Menu>
              ...
              <Item onClick={() => this.handleOnClick(DebtStatus.PAID)} type="button">
                <Status status={DebtStatus.PAID} />
              </Item>
              <Item onClick={() => this.handleOnClick(DebtStatus.UNPAID)} type="button">
                <Status status={DebtStatus.UNPAID} />
              </Item>
              <Item onClick={() => this.handleOnClick(DebtStatus.CANCELLED)} type="button">
                <Status status={DebtStatus.CANCELLED} />
              </Item>
            </Menu>
          )}
      </div>
