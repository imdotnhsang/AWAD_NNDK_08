				...
				<ActionWrapper>
					...
					>
						{status === DebtStatus.CANCELLED || status === DebtStatus.PAID ? (
							...
							>
								<path
									d='M2.5 8C2.5 6.34315 3.84315 5 5.5 5H19.5C21.1569 5 22.5 6.34315 22.5 8V10H2.5V8Z'
									fill='#26292E'
								/>
								<path
									d='M2.5 11.25H22.5V17C22.5 18.6569 21.1569 20 19.5 20H5.5C3.84315 20 2.5 18.6569 2.5 17V11.25Z'
									fill='#26292E'
								/>
							</svg>
						) : (
