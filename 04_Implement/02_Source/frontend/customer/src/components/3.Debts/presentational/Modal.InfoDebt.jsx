  ...
  return (
    ...
    >
      <Wrapper>
        ...
        <StyledRow>
          <StyledCol md={2}><Text>Status:</Text></StyledCol>
          <StyledCol md={10}><Status status={status} /></StyledCol>
        </StyledRow>
        {
          status === DebtStatus.CANCELLED
            && (
              <StyledRow>
                <ReasonTitle><Text>Reason of cancellation:</Text></ReasonTitle>
                <StyledCol md={12}>
                  <Text>{reasonOfCancel}</Text>
                </StyledCol>
              </StyledRow>
            )
        }
